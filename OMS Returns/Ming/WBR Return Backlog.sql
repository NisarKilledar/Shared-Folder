    ...
    from(
        ...
        (
            select distinct
                ...
                --and ordhead.order_no in ('6001218641', '6001218638')
                --and to_date(ordhead.order_date) between to_date('06-mar-22') and to_date('13-mar-2022')
        )
    )
)where draft_created is not null 
and draft_created between to_date('30-jan-22') and to_date('13-feb-22')
--and created is null
;
